...
public class AnimaExperimentalListView : Control
{
    ...
    protected override void OnPaint(PaintEventArgs e)
    {
        ...
        if (Items != null)
        {
            ...
            using (SolidBrush Selection = new SolidBrush(Color.FromArgb(249, 202, 36)))
...
public class AnimaProgressBar : ProgressBar
{
    ...
    protected override void OnPaint(PaintEventArgs e)
    {
        ...
        using (SolidBrush Background = new SolidBrush(Color.FromArgb(249, 202, 36)))
        {
...
public class AnimaStatusBar : Control
{
    ...
    private Color Body = Color.FromArgb(249, 202, 36);
    private Color Outline = Color.FromArgb(249, 202, 36);
    ...
    protected override void OnPaint(PaintEventArgs e)
    {
        ...
        switch (Type)
        {
            case Types.Basic:
                {
                    Body = Color.FromArgb(249, 202, 36);
                    Outline = Color.FromArgb(249, 202, 36);
                    break;
                }
...
public class AnimaTabControl : TabControl
{
    ...
    protected override void OnPaint(PaintEventArgs e)
    {
        ...
        for (var I = 0; I <= TabPages.Count - 1; I++)
        {
            ...
            {
                using (SolidBrush Background = new SolidBrush(Color.FromArgb(249, 202, 36)))
                using (Pen Border = new Pen(Color.FromArgb(249, 202, 36))
)
                {
